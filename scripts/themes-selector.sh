...
option=$(printf "Gruvbox-Materials\0icon\x1f$HOME/.config/backgrounds/assets/gruvbox.png\nCatppuccin\0icon\x1f$HOME/.config/backgrounds/assets/Catppuccin.png" | rofi -dmenu -p "Edit Config" -theme "~/.config/rofi/type-2/style-7-config")
...
case "$option" in
	"Gruvbox-Materials")        
        ...
        cp -f "$HOME/.config/colorschemes/gruvbox-materials/icons" "$HOME/.config/backgrounds/assets" #icons
	...
	cp -f "$HOME/.config/colorschemes/gruvbox-materials/hypr-apps" "$HOME/.config/hypr" #hypr apps
    ...
    "Catppuccin")
        ...
        cp -f "$HOME/.config/colorschemes/catppuccin/icons" "$HOME/.config/backgrounds/assets" #icons
	...
	cp -f "$HOME/.config/colorschemes/catppuccin/hypr-apps" "$HOME/.config/hypr" #hypr apps
        bash "$HOME/scripts/reload-config.sh" #reload config
